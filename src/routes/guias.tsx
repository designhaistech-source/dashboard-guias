    ...
    <section className="space-y-4">
      ...
      >
        ...
        <label
          ...
          className="mt-6 inline-flex items-center icon-optical gap-2 rounded-lg border border-border bg-card px-4 py-2 text-sm/none font-medium shadow-sm hover:bg-muted transition-colors cursor-pointer"
        >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-4 border-t border-border">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              Itens por página
              <button className="inline-flex items-center icon-optical gap-1 rounded-md border border-border bg-card px-2 py-1 text-sm/none text-foreground">
          ...
          <DialogBody className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-muted/30">
            <div className="lg:sticky lg:top-0 lg:self-start lg:h-[calc(92vh-3rem)] rounded-xl border border-border bg-card p-6 flex flex-col gap-4 min-h-0">
              ...
              <div className="flex justify-end">
                <button className="inline-flex items-center icon-optical gap-2 rounded-lg bg-primary text-primary-foreground px-4 py-2 text-sm/none font-medium hover:bg-primary/90 transition-colors">
                  <FileUp className="h-4 w-4" />
                  Baixar arquivo
                </button>
              </div>
...
function DateField({ label }: { label: string }) {
  return (
    <button className="inline-flex items-center icon-optical gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm/none min-w-[150px]">
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center icon-optical gap-2 rounded-lg bg-secondary text-secondary-foreground border border-border px-4 py-2 text-sm/none font-medium hover:bg-muted transition-colors"
      >
          ...
          <DialogBody className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <button
                ...
                className="inline-flex items-center icon-optical justify-center gap-2 rounded-lg bg-primary text-primary-foreground px-4 py-2.5 text-sm/none font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-primary/90"
              >
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {current.map((f) => (
                      <span
                        key={f}
                        className="inline-flex items-center icon-optical gap-2 rounded-full bg-muted px-3 py-1.5 text-sm/none"
                      >
                        {f}
                        <button
